...
public class GuiInGame {
    ...
    public void init() {
        ...
        if (foundWindowPointer.getPointer(0) != null) {
            ...
            hdc = com.sun.jna.platform.win32.User32.INSTANCE.GetDC(hwnd);
        } else {
            hwnd = null;
            hdc = null;
        }
    ...
    public void renderer() {
        ...
        User32.INSTANCE.ReleaseDC(hwnd, com.sun.jna.platform.win32.User32.INSTANCE.GetDC(hwnd));//rilascia l'hdc della finestra
    }
}
